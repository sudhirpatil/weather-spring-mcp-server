...
public class WeatherService {
	...
	private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(WeatherService.class);
	...
	try {
		...
		logger.error("Error in getWeatherForecastByLocation for lat={}, lon={}: {}", latitude, longitude, ex.getMessage(), ex);
		throw ex;
	}
}
	...
	try {
		...
		logger.error("Error in getAlerts for state={}: {}", state, ex.getMessage(), ex);
		throw ex;
	}
}
